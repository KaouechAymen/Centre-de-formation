...
public class FormateurService {
	 ...
	 * ModelMapper mapper = new ModelMapper(); Formateur formateur =
	 * mapper.map(formateurReqDTO, Formateur.class);
	 * 
	 * formateurRepos.save(formateur);
	 * 
	 * FormateurResDTO formateurResDTO= mapper.map(formateur,
	 * FormateurResDTO.class); return formateurResDTO; }
	 */
